...
def search_pws(lat, lng, state):
    ...
    # point = (-86.588136, 36.215407) # Example longitude and latitude for Atlanta, GA
    ...
    #    print("The point {} is NOT within the shapefile boundaries in state {}.".format(point, state))
